            ...
            <article class="flex">
              <article class="w-1/2 flex flex-col justify-center items-center">
                ...
                <p class="font-nuito w-8/12">
                  WishBox a luat nastere din nevoia de a avea un loc unde sa
                  putem adauga produse de care chiar avem nevoie. Multi dintre
                  noi am experimentat situatia in care am primit prea multe căni
                  de Crăciun, prea multe jucării pentru cei mici sau prea multa
                  veselă la nuntă. Așa am realizat ca ar fi mult mai eficient
                  daca ar exista o modalitate de a spune oamenilor exact ce ne
                  dorim, astfel incat sa primim cadouri care sa ne bucure cu
                  adevarat.
                </p>
              </article>
              <article class="w-1/2 flex justify-center items-center">
                <p class="font-nuito w-8/12">
                  ...
                  crea o lista cu dorintele dvs. si o puteti partaja cu
                  prietenii si familia, astfel incat sa poata vedea ce produse
                  v-ar fi de folos si sa poata alege un cadou care sa fie exact
                  ce trebuie. Indiferent de ocazie, WishBox va poate ajuta sa
                  primiti cadoul perfect.
                </p>
              </article>
            </article>
          </article>
          ...
          <article class="flex flex-col w-1/2">
            <article class="w-8/12 flex flex-col gap-2">
              ...
              <p class="font-nuito">
                ...
                produsele de care ai nevoie. Procesul este foarte simplu, dupa
                ce ai creat lista, copiaza linkul cu ajutorul butonului dedicat
                si trimite-l mai departe catre prietenii si familia ta. Astfel,
                cand cineva va bifa un cadou de pe lista ta, vei primi o
                notificare pe email. Nu mai pierde timpul si energia cu cadouri
                inutile, creaza-ti acum lista ta de dorinte si incearca sa
                primesti cadoul perfect cu ajutorul aplicatiei noastre!
              </p>
              <Button
                text="Crează lista ta de dorinte >>"
                onClick={createWishbox}
