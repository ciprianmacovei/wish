import { createContext, componentQrl, inlinedQrl, useContext, jsx, SkipRender, withLocale, noSerialize, useEnvData, useResourceQrl, useLexicalScope, useStore, useContextProvider, useWatchQrl, getLocale, Slot, useOnDocument } from "@builder.io/qwik";
...
const QwikCityProvider = /* @__PURE__ */ componentQrl(inlinedQrl(() => {
  ...
  useWatchQrl(inlinedQrl(async ({ track }) => {
    ...
    const endpointResponse = isServer ? env2.response : loadClientData(url2.href, true);
