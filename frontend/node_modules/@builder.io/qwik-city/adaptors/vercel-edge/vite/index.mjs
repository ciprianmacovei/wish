...
function vercelEdgeAdaptor(opts = {}) {
  ...
  return viteAdaptor({
    name: "vercel-edge",
    origin: ((_a3 = process == null ? void 0 : process.env) == null ? void 0 : _a3.VERCEL_URL) || "https://yoursitename.vercel.app",
    staticGenerate: opts.staticGenerate,
    staticPaths: opts.staticPaths,
    cleanStaticGenerated: true,
    config(config) {
      var _a4;
      const outDir = ((_a4 = config.build) == null ? void 0 : _a4.outDir) || ".vercel/output/functions/_qwik-city.func";
      return {
        ssr: {
          target: "webworker",
          noExternal: true
